...
!function () {
    var view = document.querySelector('.wrapper>.sign_in>form');
    var controller = {
        view: null,
        init: function init(view) {
            this.view = view;
        ...
        bindEvents: function bindEvents() {
            ...
            this.view.addEventListener('submit', function (e) {
                e.preventDefault();
                var needText = { 'email': '邮箱', 'password': '密码', 'confirmPassword': '确认密码' };
                var need = ['email', 'password', 'confirmPassword'];
                var hash = {};
                _this.clearData();
                _this.gatherData(need, hash);
                _this.verifyData(need, needText, hash);
            }, false);
        },
        ...
        gatherData: function gatherData(need, hash) {
            var _this2 = this;

            need.forEach(function (value) {
                hash[value] = _this2.view.querySelector('[name=' + value + ']').value;
            });
            return hash;
        },
        verifyData: function verifyData(need, needText, hash) {
            var _this3 = this;
            ...
            need.forEach(function (value) {
                if (hash[value] === '') {
                    _this3.view.querySelector('[name=' + value + ']').nextElementSibling.innerHTML = '\u8BF7\u8F93\u5165' + needText[value];
                }
            });
        }
        // ajaxModule: function(){
...
require('./sign_in');
},{"../css/sign.scss":"src\\css\\sign.scss","./sign_up":"src\\js\\sign_up.js","./sign_in":"src\\js\\sign_in.js"}],"..\\..\\..\\..\\AppData\\Roaming\\npm\\node_modules\\parcel-bundler\\src\\builtins\\hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/js.d231ee40.map